...
/**
 * Public alias for the styled thread history context hook.
 * Used by custom sidebar buttons (e.g. GitHubButton, TamboButton) that need
 * access to the isCollapsed state.
 */
const useThreadHistoryContext = useStyledThreadHistoryContext;
